...
```bash title="ergo vm init --ip 11.11.11.111 --ip 11.11.11.112 --ip 11.11.11.113"
===============================================================================
...
```bash title="ergo install docker --ip 11.11.11.111 --ip 11.11.11.112 --ip 11.11.11.113 --pass vagrant"
...
+ sh -c 'docker version'
...
```bash title="ergo install tools --ip 11.11.11.111 --ip 11.11.11.112 --ip 11.11.11.113 --pass vagrant"
