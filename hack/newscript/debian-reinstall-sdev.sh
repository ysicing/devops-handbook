...
curl --fail --silent --location -o /tmp/stdlib.sh https://cos.ysicing.cloud/oss/scripts/func.sh || {
	curl --fail --silent --location -o /tmp/stdlib.sh https://ghproxy.com/https://raw.githubusercontent.com/ysicing/devops-handbook/master/hack/help/func.sh
}
...
[[ -z "$LinuxMirror" ]] && LinuxMirror="http://mirrors.tencent.com/debian"
