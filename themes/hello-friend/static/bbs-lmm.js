...
let urls = [
  ...
  { home: "https://ysicing.cloud/", host: "https://note.ysicing.cloud/", apiV1: 'v1/', creatorId: "1", twiEnv: 'https://twikoo.clb.ysicing.cloud/',imgsrc:cdnGravatar+"5ca16ee587d1e4befd805cf710361f26"},
...
async function updateHTMl(data){
  ...
  for(let i=0;i < data.length;i++){
    ...
    let emojiReaction = `<emoji-reaction theme="system" class="reaction" endpoint="https://dz.12306.work" reacttargetid="${memoIdNow+'memo-'+memoId}"></emoji-reaction>`
